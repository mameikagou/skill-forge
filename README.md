...
```
Fetch https://raw.githubusercontent.com/mameikagou/cheap-hands/main/skills/opencode-coder/ai-install.md and follow the instructions inside.
```
...
```
Fetch https://raw.githubusercontent.com/mameikagou/cheap-hands/main/skills/write-skill/ai-install.md and follow the instructions inside.
```
...
```
Fetch https://raw.githubusercontent.com/mameikagou/cheap-hands/main/skills/skill-auto-installer/ai-install.md and follow the instructions inside.
```
...
```
Fetch https://raw.githubusercontent.com/mameikagou/cheap-hands/main/skills/code-graph/ai-install.md and follow the instructions inside.
```
...
1. https://raw.githubusercontent.com/mameikagou/cheap-hands/main/skills/opencode-coder/ai-install.md
2. https://raw.githubusercontent.com/mameikagou/cheap-hands/main/skills/write-skill/ai-install.md
3. https://raw.githubusercontent.com/mameikagou/cheap-hands/main/skills/skill-auto-installer/ai-install.md
4. https://raw.githubusercontent.com/mameikagou/cheap-hands/main/skills/code-graph/ai-install.md
```
