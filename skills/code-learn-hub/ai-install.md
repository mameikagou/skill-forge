...
> The user has asked you to install the "code-learn-hub" skill.
...
2. Check if `$HOME/.claude/skills/code-learn-hub/` already exists
   - If YES: Ask the user "Skill 'code-learn-hub' already installed. Overwrite? (y/n)"
   - If NO: Proceed

## Security Declaration

This installation will:
- CREATE directory: `$HOME/.claude/skills/code-learn-hub/`
- CREATE file: `$HOME/.claude/skills/code-learn-hub/SKILL.md`
...
Run: `mkdir -p $HOME/.claude/skills/code-learn-hub`

### Step 2: Write SKILL.md

Write the following content to `$HOME/.claude/skills/code-learn-hub/SKILL.md`:
...
Read `$HOME/.claude/skills/code-learn-hub/SKILL.md` and confirm:
...
If ANY step fails:
1. Delete the `$HOME/.claude/skills/code-learn-hub/` directory if it was created
